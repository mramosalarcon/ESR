...
public partial class avanceDeDiagnostico : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (DataRow drTema in respuestas.Tables["Tema"].Rows)
        {
            ...
            if (Request.Params["evidencias"] != null)
            {
                ...
                if (Request.Params["evaluacion"] != null)
                {
                    ...
                    tblCellTituloEvaluacion.Text = "Evaluaci�n";
            ...
            //tblCellTituloEvidencias.Text = "Evidencias del �mbito: " + respuestas.Tables["Evidencia_Indicador"].Select("idTema = " + drTema["idTema"].ToString()).Length.ToString();
            ...
            foreach (DataRow drSubtema in drTema.GetChildRows("S"))
            {
                ...
                foreach (DataRow rowIndi in respuestas.Tables["Indicador"].Select("idTema = " + drTema["idTema"].ToString() + " and idSubtema = " + drSubtema["idSubtema"].ToString()))
                {
                    ...
                    //Si viene el parametro del id de Empresa se muestra el de la empresa que viene como par�metro
                    if (Request.Params["idEmpresa"] == null)
                ...
                if (Request.Params["evaluacion"] != null)
                {
                    ...
                    tblCellTituloPrecalificacion.Text = "Precalificaci�n";
                    tblCellEvaluador.Text = "Evaluaci�n";
        ...
        if (flgLiberaCuestionario && iContadorIndicadores > 0)
        {
           ...
           "javascript:alert('�Est� seguro de querer liberar el cuestionario para evaluación?')");
...
//window.location="http://www.yahoo.com/"
    ...
    /// <summary>
    /// M�todo para liberar el cuestionario
    /// Tiene que validar que est� completo al 100%
    /// Que est�n seleccionadas todas las evidencias electr�nicas.
    /// </summary>
    ...
    protected void btnLiberarCuestionario_Click(object sender, EventArgs e)
    {
        ...
        if (chkConfirmaLiberacion.Checked)
        {
            ...
            //Falta mandar mensaje de confirmaci�n
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "Liberaci�n de cuestionario", "alert('Hubo un error al liberar su cuestionario, intente salir, entrar a la aplicación y liberar cuestionario nuevamente.');", true);
    ...
    protected void btnCalcularEvaluacion_Click(object sender, EventArgs e)
    {
        ...
        //else
        //{
        //    lblError.Text = "El valor ingresado en la evaluaci�n supera los 3 puntos destinados para este indicador, por favor ingrese otro valor.";
        //}
