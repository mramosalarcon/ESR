...
public partial class buscadorDeEmpresas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            // Primero pregunta si trae el par�metro idEmpresa
    ...
    protected void btnBuscar_Click(object sender, EventArgs e)
    {
        if (txtBuscar.Text.Length > 1)
        {
            ...
            lblMensaje.Text = "De click en el logotipo de la empresa para enviarle la solicitud de vinculaci�n al responsable  de dicho registro";
